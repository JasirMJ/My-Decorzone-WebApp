    ...
    axios(config)
      .then(function (response) {
        ...
        if (response.data) {
          ...
          // userDetails()
          setuserdata({ username: '', first_name: '', email: '', mobile: '' })
        }
      })
                                ...
                                <div className="ec-vendor-block-profile">
                                  <div className="ec-vendor-block-img space-bottom-30">
                                    <div className="ec-vendor-block-bg">
                                      <a href="#" className="btn btn-lg btn-primary" data-link-action="editmodal" title="Edit Detail" data-bs-toggle="modal" data-bs-target="#edit_modal" onClick={() => { setuserdata({ ...userdata, username: userDetails.username, first_name: userDetails.first_name, mobile: userDetails.mobile, email: userDetails.email }) }}>Edit Detail</a>
                                    </div>
        ...
        <div className="modal-dialog d-flex align-items-center" role="document">
          <div className="modal-content">
            <div className="modal-body">
              <div className="row">
                <div className="ec-vendor-block-img space-bottom-30" style={{ height: '32vh' }}>
                  <div className="ec-vendor-block-bg cover-upload d-none">
                    <div className="thumb-upload">
                      <div className="thumb-edit">
                        ...
                        <label><img src="assets/images/icons/edit.svg" className="svg_img header_svg" alt="edit" /></label>
                      </div>
                      <div className="thumb-preview ec-preview">
                        <div className="image-thumb-preview">
                          <img className="image-thumb-preview ec-image-preview v-img" src="assets/images/banner/8.jpg" alt="edit" />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="ec-vendor-block-detail d-none">
                    <div className="thumb-upload">
                      ...
                      <div className="thumb-preview ec-preview">
                        <div className="image-thumb-preview">
                          <img className="image-thumb-preview ec-image-preview v-img" src="assets/images/user/1.jpg" alt="edit" />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="ec-vendor-upload-detail">
                    <form className="row g-3">
                      <div className="col-md-6 space-t-15">
                        ...
                        <input type="text" className="form-control" onChange={(e) => setuserdata({ ...userdata, username: e.target.value })} value={userdata.username} />
                      </div>
                      <div className="col-md-6 space-t-15">
                        <label className="form-label">First name</label>
                        <input type="text" className="form-control" onChange={(e) => setuserdata({ ...userdata, first_name: e.target.value })} value={userdata.first_name} />
                      </div>
                      ...
                      <div className="col-md-6 space-t-15">
                        ...
                        <input type="text" className="form-control" onChange={(e) => setuserdata({ ...userdata, email: e.target.value })} value={userdata.email} />
                      </div>
                      {/* <div className="col-md-6 space-t-15">
                      ...
                      <div className="col-md-6 space-t-15">
                        ...
                        <input type="text" className="form-control" onChange={(e) => setuserdata({ ...userdata, mobile: e.target.value })} value={userdata.mobile} />
                      </div>
                      {/* <div className="col-md-6 space-t-15">
