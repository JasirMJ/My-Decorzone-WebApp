                      ...
                      <form action="#">
                        <div className="table-content cart-table-content">
                          <table>
                            ...
                            <tbody>
                              <tr>
                                <td data-label="Product" className="ec-cart-pro-name"><a href="product-left-sidebar.html"><img className="ec-cart-pro-img mr-4" src="assets/images/product-image/1.jpg" alt />Stylish Baby Shoes</a></td>
                                <td data-label="Price" className="ec-cart-pro-price"><span className="amount">$56.00</span></td>
                                <td data-label="Quantity" className="ec-cart-pro-qty" style={{ textAlign: 'center' }}>
                                  <div className="cart-qty-plus-minus">
                                    <input className="cart-plus-minus" type="text" name="cartqtybutton" defaultValue={1} />
                                  </div>
                                </td>
                                <td data-label="Total" className="ec-cart-pro-subtotal">$56.00</td>
                                <td data-label="Remove" className="ec-cart-pro-remove">
                                  <a href="#"><i className="ecicon eci-trash-o" /></a>
                                </td>
                              </tr>
                              <tr>
                                <td data-label="Product" className="ec-cart-pro-name"><a href="product-left-sidebar.html"><img className="ec-cart-pro-img mr-4" src="assets/images/product-image/2.jpg" alt />Unisex Fully Solid Hoodie</a></td>
                                <td data-label="Price" className="ec-cart-pro-price"><span className="amount">$75.00</span></td>
                                <td data-label="Quantity" className="ec-cart-pro-qty" style={{ textAlign: 'center' }}>
                                  <div className="cart-qty-plus-minus">
                                    <input className="cart-plus-minus" type="text" name="cartqtybutton" defaultValue={1} />
                                  </div>
                                </td>
                                <td data-label="Total" className="ec-cart-pro-subtotal">$75.00</td>
                                <td data-label="Remove" className="ec-cart-pro-remove">
                                  <a href="#"><i className="ecicon eci-trash-o" /></a>
                                </td>
                              </tr>
                              <tr>
                                <td data-label="Product" className="ec-cart-pro-name"><a href="product-left-sidebar.html"><img className="ec-cart-pro-img mr-4" src="assets/images/product-image/3.jpg" alt />Beautiful T-shirt For Women</a></td>
                                <td data-label="Price" className="ec-cart-pro-price"><span className="amount">$48.00</span></td>
                                <td data-label="Quantity" className="ec-cart-pro-qty" style={{ textAlign: 'center' }}>
                                  <div className="cart-qty-plus-minus">
                                    <input className="cart-plus-minus" type="text" name="cartqtybutton" defaultValue={1} />
                                  </div>
                                </td>
                                <td data-label="Total" className="ec-cart-pro-subtotal">$48.00</td>
                                <td data-label="Remove" className="ec-cart-pro-remove">
                                  <a href="#"><i className="ecicon eci-trash-o" /></a>
                                </td>
                              </tr>
                        ...
                        <form action="#" method="post">
                          <span className="ec-cart-wrap">
                            ...
                            <span className="ec-cart-select-inner">
                              <select name="ec_cart_country" id="ec-cart-select-country" className="ec-cart-select">
                          ...
                          <span className="ec-cart-wrap">
                            ...
                            <span className="ec-cart-select-inner">
                              <select name="ec_cart_state" id="ec-cart-select-state" className="ec-cart-select">
