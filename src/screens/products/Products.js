...
const Products = () => {
  ...
  const handlePrev = () => {
    ...
    var config = {
      method: "get",
      url:
        prev.replace("http:", protocol.replace("//", "")) + `&search=${param}`,
      // url: prev + "/?" + params,
  ...
  const handleNext = () => {
    ...
    var config = {
      method: "get",
      url:
        next.replace("http:", protocol.replace("//", "")) + `&search=${param}`,
      // url: next + "/?" + params,
                        ...
                        <ul className="ec-pro-pagination-inner">
                          {prev != null && (
                            <li>
                              ...
                              >
                                <i className="ecicon eci-angle-left" /> Previous
                              </a>
                            </li>
                          )}
